...
export function SuspendAccountModal({ isOpen, onClose, studentName }: SuspendAccountModalProps) {
      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col animate-in zoom-in-95 duration-200 border border-red-100">
        ...
        <div className="px-6 py-4 border-b border-red-100 flex items-center justify-between bg-red-50 text-red-900">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold">Suspend Student Account</h3>
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh] space-y-6">
          <div className="bg-red-50 border border-red-200 p-5 rounded-xl flex gap-4 text-red-900 shadow-sm">
            ...
            <div className="text-sm space-y-2">
              <p className="font-bold text-base">Immediate Access Restriction</p>
              <p>Suspending this account will immediately revoke {studentName}'s access to the clearance portal.</p>
              <ul className="list-disc pl-5 space-y-1">
                <li>Active sessions will be terminated.</li>
                <li>Clearance workflows will be frozen.</li>
                <li>The student will receive an email notification regarding the suspension.</li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <select className="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm bg-white text-slate-900 focus:border-red-500 focus:ring-2 focus:ring-red-200 outline-none mb-3">
              ...
              <option value="academic">Academic Dismissal</option>
              <option value="fraud">Fraudulent Document Submission</option>
            ...
            <textarea 
              ...
              placeholder="Internal Notes (Visible only to authorized officers)..."
            ></textarea>
          </div>
          ...
          <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
            ...
            <label className="flex items-center gap-2 text-sm text-slate-700 mt-3 cursor-pointer">
              ...
              Send automated suspension notification email to student
            </label>
          </div>
        </div>
